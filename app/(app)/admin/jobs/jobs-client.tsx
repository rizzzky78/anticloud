              ...
              <Table>
                <TableHeader className="bg-muted/30">
                  <TableRow>
                    ...
                    <TableHead className="max-w-[250px]">Error Message</TableHead>
                    ...
                    <TableRow>
                      <TableCell colSpan={7} className="h-32 text-center text-muted-foreground">
                        <div className="flex flex-col items-center justify-center space-y-1">
                          ...
                          <span className="text-sm font-medium">No background jobs found</span>
          ...
          <SheetContent className="sm:max-w-xl overflow-y-auto">
            <SheetHeader className="space-y-1.5 pb-4 border-b border-border/80">
              <SheetTitle className="text-lg font-bold flex items-center gap-2">
                <Briefcase className="size-5 text-primary" /> Inspect Job Details
              </SheetTitle>
            ...
            <div className="space-y-5 py-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm">
                    <strong>{selectedJob.attempts}</strong> of <strong>{selectedJob.maxAttempts}</strong> maximum
                  </p>
                </div>
                <div className="space-y-1">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
